	...
	public class text {
		...
		static String[] strings = { "  ", "  ", "..", "..", "``", "``", "--", "--", ";;", ";;", ";;", ";;", "\"\"", "\"\"",
				"__", "__", "ii", "ii", "rr", "rr", "jj", "½º", "}}", "¼ö", "vv", "½´", "xx", "Áî", "yy", "ÁÖ", "zz", "UU", "uu",
				"Ãß", "kk", "mm", "hh", "HH", "KK", "ww", "qq", "NN", "99", "DD", "SS", "ÆD", "gg", "ÆJ", "RR", "ÆF", "$$", "År",
				"ÆI", "Åœ", "BB", "MM", "##", "Å”", "Ä—", "Åh", "¿œ", "¿f", "@@", "—Ò", "–ã", "—e", "—†", "–æ" };
		...
		public static void a () throws IOException {
			...
			BufferedImage im = ImageIO.read(new File("C:\\Users\\308\\Desktop\\ÀÌÀÌŸç\\download.jpg"));
	...
	FileWriter fw = new FileWriter(new File("C:\\Users\\308\\Desktop\\ÀÌÀÌŸç\\ÀÌÀÌÀ×.txt"));
